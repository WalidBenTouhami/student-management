...
export MYSQL_ROOT_PASSWORD="***-$(openssl rand -hex 8)"
export MYSQL_APP_USER="student_user"
export MYSQL_APP_PASSWORD="***-$(openssl rand -hex 8)"
export ACTUATOR_USER="actuator-admin"
export ACTUATOR_PASSWORD="***-$(openssl rand -hex 8)"
export API_USER="api-user"
export API_PASSWORD="***-$(openssl rand -hex 8)"
