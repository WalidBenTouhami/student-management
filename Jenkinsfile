        ...
        stage('SonarQube Analysis') {
            steps {
                withSonarQubeEnv('SonarQube') {
                    sh "chmod +x mvnw && ./mvnw sonar:sonar -Dsonar.projectKey=student-management -Dsonar.projectName='Student Management' -Dsonar.host.url=${SONAR_HOST_URL} -Dsonar.token=squ_1a68065e9dfc64029cc28b2f1c355beab1c5cc1c -Dsonar.coverage.jacoco.xmlReportPaths=target/site/jacoco/jacoco.xml"
                }
            }
        }
