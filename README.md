...
```powershell
docker run -e SPRING_DATASOURCE_URL="jdbc:mysql://host:3306/studentdb" -e SPRING_DATASOURCE_USERNAME=root -e SPRING_DATASOURCE_PASSWORD=pass -e SERVER_PORT=8089 -p 8089:8089 <namespace>/student-management:latest
```
